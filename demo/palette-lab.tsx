      ...
      <aside className="lab__panel">
        ...
        <div className="lab__group">
          ...
          <p className="lab__hint">
            ...
            же цвет, разный размер. Переключение на «прежнюю» показывает разницу с
            DS-122: JIG-12 добавил зелёный и красный тона по запросу потребителя и
            поднял контраст к поверхности с 3.0 до 3.5.
          </p>
        </div>
      </aside>
