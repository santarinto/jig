import { Close, Icon, Button } from '@santarinto/jig'

// Крестик закрытия: диалог, шторка, уведомление, сброс значения.
//
...
export const Default = () => (
  <div style={{ display: 'flex', gap: 20, alignItems: 'center', fontSize: 'var(--ds-fs-md)' }}>
    <Icon><Close /></Icon>
    <Icon style={{ color: 'var(--ds-text-secondary)' }}><Close /></Icon>
    <Icon style={{ color: 'var(--ds-accent)' }}><Close /></Icon>
  </div>
)
...
export const InButton = () => (
  <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
    <Button variant="secondary">Закрыть <Icon><Close /></Icon></Button>
    <Button variant="ghost" iconOnly aria-label="Закрыть"><Icon><Close /></Icon></Button>
  </div>
)
